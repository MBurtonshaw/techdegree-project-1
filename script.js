...
function printQuote() {
    for (var i = 0; i < quotes.length; i++) {
        ...
        quoteBox.innerHTML = "<p class='quote'>" + quoteVar.quote + "</p>" + "<p class='source'>" + quoteVar.source + "<span class='citation'>" +  quoteVar.citation + "</span>" + "<span class='year'>" + quoteVar.year + "</span>" + "</p>";
    }
}
